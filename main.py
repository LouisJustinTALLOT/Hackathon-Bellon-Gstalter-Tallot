...
pg.init()
pg.display.set_caption('Rogue Bellon Gstalter Tallot')
clock = pg.time.Clock()
images = [pg.image.load("images/sol.png"), 
          ...
          pg.image.load("images/mystere.png"),
          pg.image.load("images/potion2.png"),
          pg.image.load("images/mur_intersection.png"), 
          pg.image.load("images/monstre_aquatique.png"), 
          pg.image.load("images/monstre_herbeux.png")
] #images à afficher
